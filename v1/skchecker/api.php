...
if(isset($res1['error'])){
    if (isset($res1['error']['type'])&&$res1['error']['type'] == 'invalid_request_error') {
        echo '* <span class="label label-danger">DEAD </span> * <span class="label label-warning">@fakehecker </span> * <span class="label label-primary"> Your Secret Key Is Dead</span> * <span class="label label-info">'.$sk.'</span> *';
    }else{
        echo '* <span class="label label-success">LIVE </span> * <span class="label label-info">@fakehecker </span> * <span class="label label-warning"> Your Secret Key Is Active</span> * <span class="label label-primary">'.$sk.'</span> *';
    }
}else{
    if(isset($res2['error'])){
