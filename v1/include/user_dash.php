<h3 class="mtitle" > Your account status is <span class="tag_success">Approved</span></h3>
                ...
                <p class="uk-text-lead uk-text-muted">Congratulations!! your account account has been approved by 𝗛𝗘𝗖𝗞𝗘𝗥.</p>
...
<div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                ...
                <div class="uk-border-circle uk-avatar-small s_logo" ></div>
                  <div>
                   <h3><a href="">HECKER SK BASED [Slow]</a></h3>
...
<div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                ...
                <div class="uk-border-circle uk-avatar-small s_logo" ></div>
                  <div>
                   <h3><a href=""> HECKER NONSK 1 [Fast]</a></h3>
                   <span class="tag_active">active</span> 
...
<!-- card three  -->
<div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                <a class="uk-position-cover" href="./nonsk2"></a>
               
                <div class="uk-article-meta uk-flex uk-flex-middle">
                  <div class="uk-border-circle uk-avatar-small s_logo" ></div>
                  <div>
                   <h3><a href=""> HECKER NONSK 2 [Slow]</a></h3>
                   <span class="tag_active">Active</span>
...
<div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                ...
                <div class="uk-border-circle uk-avatar-small s_logo" ></div>
                  <div>
                   <h3><a href="">SK KEY CHECKER [Fast]</a></h3>
                   <span class="tag_active">NO CSS + NO STEALER</span> 
