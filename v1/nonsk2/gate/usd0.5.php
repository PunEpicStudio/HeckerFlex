...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount=50&currency=usd&payment_method_types[]=card&description=Gunnu Donation&payment_method='.$tok1.'&confirm=true&off_session=true');
...
elseif(strpos($result2, "lost_card" )) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY 𝗛𝗘𝗖𝗞𝗘𝗥 🇧🇩</span> <br>';
}
